...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.UPDATE, query = "UPDATE Meal m SET m=:meal WHERE m.user.id=:userId")
        })
@Entity
@Table(name = "meals",
        uniqueConstraints = @UniqueConstraint(name = "meals_unique_user_datetime_idx",
